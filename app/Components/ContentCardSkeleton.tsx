...
const SkeletonComponent = () => {
  return (
    <div className="items-center justify-center py-2 px-10 md:px-20">
      <div className="flex-col flex border-[1px] animate-pulse duration-800 transition-all bg-gray-200 shadow-md h-[auto] rounded-lg">
        <div className="items-start justify-start gap-8 p-4 flex-col md:flex-row flex">
          ...
          <div className="flex flex-col gap-y-[70px] h-auto w-full">
            <div className="w-full h-8 rounded-md bg-gray-100" />
            <div className="w-20 h-6 rounded-md bg-gray-100" />
